...
CONFIG={"seed": 42,
        ...
        "num_layers":3,
         "vocab_index_path": "../input/vocab2index.txt",
          ...
          "checkpoint_directory_path": '../models/checkpoints/lstm',
...
if __name__ == "__main__":
    ...
    df['encoded']=df['encoded'].apply(lambda x: np.fromstring(x, dtype=int, sep=' '))
    ...
    for fold in range(0, CONFIG['n_fold']):
        ...
        model = JigsawLSTMModel(CONFIG['vocab_size'],CONFIG['embedding_dim'],CONFIG['hidden_dim'],CONFIG['num_layers'])
